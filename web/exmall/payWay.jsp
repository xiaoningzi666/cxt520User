	...
	<body >
		...
		<div class="mui-content" style="padding: 50px 0;">
			...
			<form class="mui-input-group myinputgroup">
					...
					<div class="mui-input-row mui-radio mymuiradio">
						<label><span class="iconfont icon-zhifubao blue" ></span> 支付宝</label>
...
<script type="text/javascript">
	...
	mui.init();
	$('#total').text("¥"+$.getUrlParam("postage"))
	$('#backPay').click(function(){
		$(this).attr('href','jfOrder_success.jsp?orderId='+$.getUrlParam('orderId'))
	})
</script>
	</body>
